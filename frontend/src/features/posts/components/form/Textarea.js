        ...
        <div className={`form__textarea ${err ? 'errborder' : ''}`}>
            <Editor
                ...
                init={{
                    ...
                    toolbar:
                        'undo redo | bold italic | alignleft aligncenter alignright | numlist bullist | h1 h2 h3 | codesample',
                    statusbar: false,
                    height: '100%',
                    content_style:
                        "@import url('https://fonts.googleapis.com/css2?family=Noto+Serif+Toto" +
